        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <div className="search-input-section mb-3 p-3 border rounded">
                        <h5>Search</h5>
                        {/* 1. Add text input field for search criteria */}
                        <div className="form-group">
                            ...
                            <input
                                ...
                                value={searchQuery} // Conecta o valor do input ao estado searchQuery
                                onChange={(e) => setSearchQuery(e.target.value)} // Atualiza o estado searchQuery ao digitar
                            />
                        </div>
                        {/* 2. Implement search button with onClick event to trigger search: */}
                        <button
